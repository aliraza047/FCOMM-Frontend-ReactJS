                ...
                ? all_users.map((data, id) => ({
                      ...
                      approve: (
                          <Switch
                              ...
                              onChange={(x) => dispatch(approveUser({ id: data._id }, 'designer'))}
                          />
                      ),
                      action: (
                          <div>
                            ...
                            {/* <div className="col-lg-4 col-md-4">
                                <div className="search-fields">
                                    <FormControl variant="standard" className="input-field">
                                        <BootstrapInput placeholder="Date" id="bootstrap-input" />
                                    </FormControl>
                                </div>
                            </div> */}
...
export default ApprovedDesigner;
