...
const PaymentDesigner = () => {
    ...
    console.log('all_payments manufacture de', all_payments);

    useEffect(() => {
        dispatch(getAllPayment({ role: 'designer', status: 'approved' }));
        return () => {
    ...
    console.log('get all payments Designer', all_payments);
...
export default PaymentDesigner;
