        ...
        <div className="stories-crousel">
            <div className="container">
                ...
                {window.screen.width < 1024 ? (
                    ...
                    <div>
                        <div className={`${isArrayCheck(all_blogs_data) && all_blogs_data.length >= 5 ? '' : 'd-none'}`}>
                            <Slider {...settings}>
                                {all_blogs_data.map((data, id) => (
                                    <StylistCarouselItem
                                        img={
                        ...
                        <div
                            className={`d-flex flex-row text-center single-img justify-content-center ${
                                isArrayCheck(all_blogs_data) && all_blogs_data.length >= 5 ? 'd-none' : ''
                            }`}
                        >
                            {all_blogs_data.map((data, id) => (
                                <StylistCarouselItem
